...
content += "회원 id + " + sender +
"<br>회원정보는 !!! <a href='http://localhost:8080/Funweb_Starter_Project/member/member_info.jsp?idx=" + sender + "'></a>";
try {
	// ------------------------ 메일 전송을 위한 설정 작업 ------------------------------
	...
	// => 파라미터 : 발신자 주소, 발신자 이름
	Address senderAddress = new InternetAddress(sender, member.getName());
	// 2) 수신자 정보 설정을 위한 InternetAddress 객체 생성
	// => 파라미터 : 수신자 주소
	Address receiverAddress = new InternetAddress("yongs1041@naver.com");
