...
List<FileBoardDTO> fileList = dao.selectFileBoardList(startRow, listLimit, keyword);
	...
	<div id="wrap">
		...
		<article>
			...
			<div id="page_control">
				...
				// 1. BoardDAO 객체의 selectFileBoardListCount() 메서드를 호출하여 전체 게시물 수 조회(페이지 목록 계산에 사용)
